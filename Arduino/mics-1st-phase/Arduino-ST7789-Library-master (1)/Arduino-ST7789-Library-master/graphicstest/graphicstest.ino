...
// #define TFT_DC 17   // 
// #define TFT_RST 5   // LCD Rest
// #define TFT_CS -1   // blank SS
// #define TFT_MOSI 18 // SDA for hardware SPI data pin (all of available pins)
// #define TFT_SCLK 19 // SCL for hardware SPI sclk pin (all of available pins)
